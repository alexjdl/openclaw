...
COPY --from=runtime-assets --chown=node:node /app/openclaw.config.json .
...
CMD ["node", "openclaw.mjs", "gateway", "--allow-unconfigured", "--bind", "lan", "--config", "openclaw.config.json"]
